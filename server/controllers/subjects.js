...
const addSubjects = async (req,res,next)=>{
   ...
   if(isValidSubject)
   {
       return next(new HttpError("Subject exists.Try adding different subject",500))
   };
   ...
   {
       return next(new HttpError("Could not add subject",500));
   };
...
const addAttendance = async (req,res,next)=>{
   ...
   {
       return next(new HttpError("Subject Not Found ",500));
   };
   ...
   if(isDateExist)
   {
       return next(new HttpError("Attendance exist for the entered date",500));
   }
   const newAttendance = {
...
const deleteAttendance = async (req,res,next)=>{
    ...
    {
        return next(new HttpError("Attendance not found ",500));
    }
...
const updateAttendance = async (req,res,next)=>{
    ...
    const foundSubjectIndex = existingUser.subjects.findIndex((element)=>{
       ...
       {
           return next(new HttpError("Attendance not found,so could not update attendance",500));
       }
